...
const loadRecipeById = async function (req, res) {
  console.log("loadRecipeById");
  try {
...
/*module.exports = (req, res) => {
  const recipe = {
    ...
    description:
      "Indulge in a tantalizing Mediterranean experience with this Chef's special cod dish. Succulent cod fish perfectly complemented by a vibrant medley of roasted vegetables. It's a symphony of flavors bound to delight your palate.",
    ...
    notes:
      "Ensure the fish is fresh for the best taste. You can customize the vegetable selection according to your preference.",
